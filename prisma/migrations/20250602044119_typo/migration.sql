...
-- AlterTable
ALTER TABLE `master_coa` DROP COLUMN `anaysisDate`,
    DROP COLUMN `carbonConten`,
    DROP COLUMN `forignMater`,
    ADD COLUMN `analysisDate` DATETIME(3) NULL,
    ADD COLUMN `carbonContent` VARCHAR(191) NULL,
    ADD COLUMN `foreignMatter` VARCHAR(191) NULL;
